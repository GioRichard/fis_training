...
import fis.bank.criminalsystemmanagement.repository.mapper.DetectiveRowMapper;
...
public class DetectiveRepositoryImpl extends AbstractRepositoryImpl<Detective> implements DetectiveRepository {
    ...
    public void create(Detective detective) {
        jdbcTemplate.update(
                "insert into detectives(id, create_time, modify_time, armed, badge_number," +
                        " employmentStatus, `rank`,person_id) " +
                        "values(?,?,?,?,?,?,?,?)",
