...
public class LopHoc {
    ...
    */
        ...
        sbd.append("Danh Sach Diem Lop:" + this.ten);
        sbd.append("Giao Vien Chu Nhiem:" + this.giaoVien);
        int count = 1;

        sbd.append("STT\t" + "MSSV\t" + "Ten\t" + "Diem TB" + "Xep Loai\t");

        for (SinhVien s: dsLop) {
            sbd.append((count++)+ "\t"+this.giaoVien+"\t"+s.tinhDiemTrungBinh()+"\t"+s.xepLoai());
            sbd.append("\n");
        }
        return sbd.toString();
    }
