...
public class Detective {
    ...
    public Detective(Long id, int version, LocalDateTime createdAt, LocalDateTime modifiedAt, Person person, String badgeNumber, Rank rank, Boolean armed, EmploymentStatus status,
