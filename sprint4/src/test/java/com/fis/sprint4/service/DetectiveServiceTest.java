...
import com.fis.sprint4.repository.DetectiveRepository;
...
class DetectiveServiceTest {
    ...
    void getDetectives() {
        ...
        detective2.setBadgeNumber("bed4");
    ...
    void getDetective() {
        ...
        detective.setVersion(1);
        detective.setArmed(true);
        detective.setBadgeNumber("1111");
        detective.setRank(Rank.valueOf("SENIOR"));
        detective.setStatus(EmploymentStatus.valueOf("VACATION"));
        Person person = new Person();
        person.setId(2L);
        detective.setPerson(person);
        Mockito.when(this.detectiveRepository.findById(4L)).thenReturn(Optional.of(detective));
